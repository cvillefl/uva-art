...
<div id="content">
	...
	<div class="span50">
		<h1>Art History Faculty, 2013-2014</h1>
	...
	<div class="span50 end rc">
		...
		foreach ($emeritus as $f) {
			...
			<p class="hang">
				<?php if ($f['link']) { ?><b><a href="<?php p('faculty'); ?>art-history/<?php echo $i; ?>/<?php echo strtolower(str_replace('.','',str_replace(' ','-',$f['name']))); ?>"><?php echo $f['name']; ?></a></b><?php } else { ?><b class="fours"><?php echo $f['name']; ?></b><?php } ?>, <i><?php echo $f['title']; ?></i><br></span>
		        <?php if ($f['area'] != '') echo $f['area'] . '<br>'; ?>
		        <?php echo $f['school']; ?><br>
		        <a href="mailto:<?php echo $f['email']; ?>" target="_blank">Email ></a>
			</p>
